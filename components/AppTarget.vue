<template>
    <section id="targets-section" class="container mt-32 mx-auto px-4">
        ...
        <div class="lg:flex justify-between targets-intro">
            <div class="basis-1/2">
                <h2 class="text-[35px] lg:text-[40px]">Tutta la nostra esperienza nel marketing immobiliare a tua disposizione</h2>
            </div>
