<template>
    <section ref="testimonials" id="testimonials"
        ...
        <div class="testimonials relative">
            ...
            <div
                class="testimonial-box lg:w-[470px] w-[350px] lg:h-[325px] h-[350px] box-1 absolute left-[50%] translate-y-[30%] translate-y-[30%] lg:top-[50%] translate-x-[-50%] lg:translate-y-[-50%] rotate-[-2deg]">
                <h4>Concept Home</h4>
                <h6>Agenzia Immobiliare con 5 sedi a Roma</h6>
                <p><span>Processo:</span> Strutturazione di una strategia personalizzata per l'acquisizione d'immobili
                    in esclusiva</p>
            ...
            <div
                class="testimonial-box lg:w-[470px] w-[350px] lg:h-[360px] h-[420px] box-2 absolute left-[50%] translate-x-[-50%] translate-y-[30%] lg:left-[15%] lg:top-0 lg:translate-x-0 lg:translate-y-[-70%] rotate-[-7deg]">
                <h4>Daniel Ghione</h4>
                <h6>consulente immobiliare regione Piemonte</h6>
                <p><span>Processo:</span> Rafforzamento personal brand per attrarre clienti venditori pronti e motivati
                    a vendere il loro immobile con la sua consulenza</p>
                <p><span>Risultato:</span> 2 incarichi firmati d'immobili dal valore provvigionale di € 20.000 e altri 4
                    in lavorazione nei primi 45 giorni</p>
                <div class="flex video-link items-center gap-4 absolute -left-6">
                    <figure>
                        <svg width="50" height="50" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="28.0605" cy="28.2378" r="26" transform="rotate(-1.93961 28.0605 28.2378)"
            ...
            <div
                class="testimonial-box lg:w-[470px] w-[350px] lg:h-[325px] h-[380px] box-3 absolute left-[50%] translate-x-[-50%] translate-y-[30%] lg:right-[15%] lg:bottom-0 lg:translate-x-0 lg:translate-y-[80%] rotate-[10deg]">
                <h4>BeHome</h4>
                <h6>Agenzia Immobiliare a Salò</h6>
                <p><span>Processo:</span> Creazione di un eco-sistema di marketing digitale per attrarre clienti
                    venditori di target medio-alto</p>
                <p><span>Risultato:</span> 2 incarichi d'immobili dal valore provvigionale di € 40.000 e altri 4
                    immobili in trattativa nei primi 75 giorni</p>
                <div class="flex video-link items-center gap-4 absolute -left-6">
                    <figure>
                        <svg width="50" height="50" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="28.0605" cy="28.2378" r="26" transform="rotate(-1.93961 28.0605 28.2378)"
            ...
            <div
                class="testimonial-box lg:w-[470px] w-[350px] lg:h-[380px] h-[440px] box-4 absolute left-[50%] translate-x-[-50%] translate-y-[20%] lg:left-[15%] lg:bottom-0 lg:translate-x-0 lg:translate-y-[80%] rotate-[-15deg]">
                <h4>Replat</h4>
                <h6>Agenzia Immobiliare su Campobasso</h6>
                <p><span>Processo:</span> Strutturato un processo di marketing che permettesse di avere notizie di
                    clienti venditori profilati e pronti a vendere il proprio immobile</p>
                <p><span>Risultato:</span> Avendo strutturato bene il processo di marketing sin dall'inizio, nelle prime
                    due settimane di lavoro hanno effettuato più di 10 appuntamenti con persone intenzionate a vendere
                    in zona</p>
                <div class="flex video-link items-center gap-4 absolute -left-6">
                    <figure>
                        <svg width="50" height="50" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div
                class="testimonial-box lg:w-[470px] w-[350px] lg:h-[350px] h-[400px] box-5 absolute left-[50%] translate-x-[-50%] translate-y-[30%] lg:right-[15%] lg:top-0 lg:translate-x-0 lg:translate-y-[-80%] rotate-[15deg] ms-5 lg:ms-0">
                <h4>Frimm</h4>
